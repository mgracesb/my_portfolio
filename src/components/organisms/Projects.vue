          ...
          >
            ...
            >
              <img
                ...
                src="@/assets/projects/cosmicsnap.svg"
              />
...
.projects
  ...
  &__state
    ...
    transform: rotate(-90deg) translateX(3.5rem) translateY(1.5rem)
  ...
  @include pc-min
    ...
    &__state
      transform: rotate(-90deg) translateX(3.8rem) translateY(1.5rem)
